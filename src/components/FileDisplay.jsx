  ...
  return (
    ...
    justify-center pb-20 w-fit max-w-full mx-auto'>
        ...
        <div className='flex items-center justify-between gap-4'>
            ...
            <button className='specialBtn px-3 p-2 rounded-lg text-blue-400 flex items-center gap-2 font-medium '><p>Transcribe</p><i className="fa-solid fa-pen-nib"></i></button>
        </div>
    </main>
  )
}
